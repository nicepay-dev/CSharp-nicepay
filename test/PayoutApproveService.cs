...
public class PayoutApproveService
{
    ...
    public async Task approvePayout_Test()
    {
        ...
        string createRequestBody = snapPayoutServices.ApprovePayoutRequest(
        ...
        string createResponse = await payoutService.SendPostRequest(apiEndpoints.ApprovePayout, accessToken, timestamp, createRequestBody, externalId);
