public class QrisBuilder
{
    ...
    public QrisBuilder SetQrisSnap(
    ...
    string cartData)
    {
        ...
        _requestBody["storeId"] = storeId;
        _requestBody["validityPeriod"] = validityPeriod;
